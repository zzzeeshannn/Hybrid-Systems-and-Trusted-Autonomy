...
def plot_overhead(full_states, waypoints=None, llc=None, figsize=(7, 5), plot_frame=0, plane_size_factor=0.05,
    ...
    if not isinstance(full_states, np.ndarray):
        full_states = np.array(full_states, dtype=float)
    ...
    if axis_limits is not None:
        ...
        axis_limits = set_axis_limits(ax, num_vars, full_states, zoom_factor)
