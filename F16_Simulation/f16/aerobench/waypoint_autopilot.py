...
from aerobench.autopilot import Autopilot
...
class WaypointAutopilot(Autopilot):
    ...
    moves aircraft towards self.waypoint

    '''

    def __init__(self, waypoint, gain_str='old', stdout=False):
        'waypoint is a 3-tuple'
